...
@Injectable()
export class UserAccountRegistrationAttemptedWithExistingAccountEventMapper implements EmailTemplateEventMapper<UserAccountRegistrationAttemptedWithExistingAccountEvent> {
  constructor(
    @Inject(
