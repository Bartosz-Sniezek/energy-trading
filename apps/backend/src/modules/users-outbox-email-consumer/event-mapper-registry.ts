...
export class EventMapperRegistry {
  private readonly mappers: Map<string, EmailTemplateEventMapper<unknown>>;
  ...
  constructor(
    ...
    this.mappers = new Map<string, EmailTemplateEventMapper<unknown>>([
  ...
  getMapper(event: DebeziumOutboxMessage): EmailTemplateEventMapper<unknown> {
